...
export EXPERIMENT_NAME=deepmath_qwen3_4B_in_distribution_ref_model_reference_replace_hard_clip_0.01-10

SAVE_PATH="./$EXPERIMENT_NAME"

# You need to manually set up a VLLM server as the reflection model
API_BASE='http://124.16.138.144:23167/v1'          # Server address of qwen3 4b 
