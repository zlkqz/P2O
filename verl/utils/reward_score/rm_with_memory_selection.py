...
def validate_response_structure(processed_str: str, verbose=False):
    ...
    valid_sequences = [
        ['<think>', '</think>', '<search>', '</search>', 
         '<information>', '</information>', '<memory_selection>', '</memory_selection>', '<my_answer>', '</my_answer>', 
        ...
        ['<think>', '</think>', '<search>', '</search>', 
         ...
         '<memory_selection>', '</memory_selection>', '<my_answer>', '</my_answer>', '<golden_answer>', '</golden_answer>', 
         '<write>', '</write>'],
        ...
        ['<search>', '</search>', '<information>', '</information>', 
         '<think>', '</think>', '<memory_selection>', '</memory_selection>', '<my_answer>', '</my_answer>', 
         '<golden_answer>', '</golden_answer>', '<write>', '</write>'],
