...
@register("memory_feedback_with_xml_tags_for_reasoning")
class MemoryFeedbackRewardManagerWithXMLTagsForReasoning:
    """
    ...
    def __call__(self, data, return_dict=False):
        ...
        results = self.validate_conversations_parallel(data)
